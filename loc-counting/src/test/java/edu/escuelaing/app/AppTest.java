    ...
    extends TestCase
{
    ...
    {
        Phy phy= new Phy("src\\test\\java\\edu\\escuelaing\\app\\Prueba.java");
        try {
    ...
    {
        Loc loc= new Loc("src\\test\\java\\edu\\escuelaing\\app\\Prueba.java");
        try {
    ...
    {
        Phy phy= new Phy("src\\test\\java\\edu\\escuelaing\\app\\Prueba2.java");
        try {
    ...
    {
        Loc loc= new Loc("src\\test\\java\\edu\\escuelaing\\app\\Prueba2.java");
        try {
